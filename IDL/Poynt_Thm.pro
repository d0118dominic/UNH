...
;timespan,'2017-07-11/22:35:06',10 , /second
...
frame = 'xline'    ;'xline' --> X-line frame
;'sc'    --> Spacecraft frame
;'e'     --> Electron frame
...
l3 = strarr(1)
l3 = 'y'            ;;;;;for l3 merged efield data, use l3 = 'y', otherwise edp by default
if (l3 eq 'y') then begin
  Tplot_restore, FILENAME='/Users/d0118/data/mms/' + sc + '/MMS' + probe + '_July11_2017_GSE_R02.tplot', /VERBOSE
...
for i= 1, N-1 do begin
  ...
  duavg[i] = (uavg[i] - uavg[i-1])/(t[i]- t[i- 1])
endfor
